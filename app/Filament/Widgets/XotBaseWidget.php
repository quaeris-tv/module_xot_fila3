...
=======
>>>>>>> 818820bc (fix(XotBaseWidget): remove duplicate use statement for FilamentWidget)
...
=======
        $view = app(GetViewByClassAction::class)->execute(static::class);
        static::$view = $view;
>>>>>>> fda02dac (fix(XotBaseWidget): remove duplicate use statement for FilamentWidget)
>>>>>>> 818820bc (fix(XotBaseWidget): remove duplicate use statement for FilamentWidget)
    }
}
